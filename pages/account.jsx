...
const account = () => {
        ...
        return (
            <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
                ...
                <div className='pb-4 m-auto'>
                    <Image className='rounded-full' src={session.user.image} alt='picture profile' width="100" height="100" />
                </div>
    ...
    return (
        <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
            ...
            <p className='py-4'>Choose the account you want to sign with.</p>
            ...
            <button className='flex items-center justify-center p-3 bg-red-600 border border-red-600 my-2' onClick={() => signIn()}><FaGoogle className='mr-2' /> Sign In with <span className='font-bold pl-1'>Google</span></button>
        </div>
    )
}
