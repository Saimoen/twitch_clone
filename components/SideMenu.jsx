...
const SideMenu = () => {
    return (
        <div className='fixed w-14 sm:w-16 xl:w-[15rem] h-screen p-2 bg-[#0e0e10] overflow-y-scroll'>
            <div>
                <p className='hidden xl:flex uppercase font-bold text-sm pb-4'>Recommanded Channels</p>
